...
function(git_cmake_project)

    cmake_parse_arguments(
            PARGS                                                                           # prefix of output variables
            "QUIET"                                                                         # list of names of the boolean arguments (only defined ones will be true)
            "PROJECT_NAME;GIT_URL;GIT_TAG;GIT_BRANCH;GIT_COMMIT;DIRECTORY;INSTALL_DIR"      # list of names of mono-valued arguments
    ...
    set(SUB_INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX})
    if(PARGS_INSTALL_DIR)
        set(SUB_INSTALL_PREFIX ${PARGS_INSTALL_DIR})
    endif()

    if(NOT PARGS_QUIET)
        message("${git_output}")
    endif()
    message(STATUS "start to install subproject ${PARGS_PROJECT_NAME}")
    message(STATUS "${${SOURCE_DIR}}")

    execute_process(
            COMMAND cmake -DCMAKE_INSTALL_PREFIX=${SUB_INSTALL_PREFIX} .
            WORKING_DIRECTORY   ${${SOURCE_DIR}}
    ...
    message(STATUS "${build_output}")
    message(STATUS "install subproject complete ${PARGS_PROJECT_NAME}")
